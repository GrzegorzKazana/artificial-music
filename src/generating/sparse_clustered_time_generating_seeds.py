...
from src.generating.sparse_generating_seeds import seed_generators as sparse_seed_generators
...
seed_generators = {
    k: wrap_seed_generator_w_duration(v) for k, v in sparse_seed_generators.items()
}
