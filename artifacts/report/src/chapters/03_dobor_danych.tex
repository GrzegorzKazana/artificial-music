\chapter {Dobór danych} 
{
    ...
    \section{Porównanie formatów danych}
    {
        ...
        \subsection{Format midi}
        {
            ...
            Dodatkowym parametrem każdej wiadomości jest wartość time, będąca ilością impulsów (ang. 'ticks') które upłynęły
    ...
    \section{Opis wybranego zbioru danych}
    {
        ...
        danych wybrałem stosunkowo mały zbiór zawierający utwory z serii gier Pokemon wyprodukowanych na konsolę Nintendo.
