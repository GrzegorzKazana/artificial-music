\chapter{Sposoby reprezentacji danych}
{
    ...
    \section{Reprezentacja wysokości dźwięków}
    {
        ...
        moglibyśmy teoretycznie wykorzystać bezpośrednio do uczenia modelu.
        ...
        \subsection{Kody 1 z N i M z N}
        {
            ...
            to nie reprezentujemy również zależności mogących być użytecznymi w procesie uczenia, 
