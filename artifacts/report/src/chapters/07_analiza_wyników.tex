\chapter{Analiza wyników}
{
    ...
    \section{Pomiar zbioru treningowego}
    {
        ...
        \begin{figure}
            \centering
            \includegraphics[scale=0.5]{tonal_hist}
        ...
        \begin{figure}
            \centering
            \includegraphics[scale=0.5]{tonal_transition}
        ...
        \begin{figure}
            \centering
            \includegraphics[scale=0.5]{rythm_hist}
        ...
        \begin{figure}
            \centering
            \includegraphics[scale=0.5]{rythm_transition}
    ...
    \section{Wyniki}
    {
        ...
        \begin{figure}
            \centering
            \includegraphics[scale=0.5]{tonal_hist_1}
        ...
        \begin{figure}
            \centering
            \includegraphics[scale=0.5]{tonal_transition_1}
        ...
        \begin{figure}
            \centering
            \includegraphics[scale=0.5]{rythm_hist_1}
        ...
        \begin{figure}
            \centering
            \includegraphics[scale=0.5]{rythm_transition_1}
    ...
    \section{Wrażenia subiektywne}
    {
        ...
        % \begin{figure}
        %     \centering
        %     \includegraphics[scale=0.5]{rythm_hist_2}
        %     \caption{Histogram występowania poszczególnych długości dźwięków w generowanych próbkach}
        %     \label{rythm_hist_2}
        % \end{figure}
        ...
        % \begin{figure}
        %     \centering
        %     \includegraphics[scale=0.5]{rythm_transition_2}
        %     \caption{Macierz przejść długości dźwięków w generowanych próbkach}
        %     \label{rythm_transition_2}
        % \end{figure}
        ...
        % \begin{figure}
        %     \centering
        %     \includegraphics[scale=0.5]{tonal_hist_2}
        %     \caption{Histogram występowania poszczególnych dźwięków w generowanych próbkach}
        %     \label{tonal_hist_2}
        % \end{figure}
        ...
        % \begin{figure}
        %     \centering
        %     \includegraphics[scale=0.5]{tonal_transition_2}
        %     \caption{Macierz przejść dźwięków w generowanych próbkach}
        %     \label{tonal_transition_2}
        % \end{figure}
